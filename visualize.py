...
# Constants
SCHEDULE_FILE = "Enemy.json"  # JSON list of events
AUDIO_FILE = "Enemy.egg"         # Your audio file
...
def main():
    ...
    # Parse events
    events = [(float(e["start"]), int(e.get("pumpkin", e.get("note", 0)))) for e in events_json]
